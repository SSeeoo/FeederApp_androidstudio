...
public class PubSubActivity extends Activity {
    ...
    // IoT endpoint
    private static final String CUSTOMER_SPECIFIC_ENDPOINT = "a3sf6jio2ot6ay-ats.iot.us-east-2.amazonaws.com";
    ...
    public void publishClick(final View view) {
        final String topic = "$aws/things/ESP32CAM/shadow/update";
        final String msg = "{ \"state\": { \"desired\": { \"property\": \"ON\" } } }";
